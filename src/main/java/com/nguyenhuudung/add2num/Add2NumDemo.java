...
/**
 * Small console front end, so the core class can be tried out without writing code.
 *
 ...
 * </pre>
 */
public final class Add2NumDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Usage: java -cp out com.nguyenhuudung.add2num.Add2NumDemo <number1> <number2>");
